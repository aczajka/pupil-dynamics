...
function errSum = fitErrorBoth(p,args)
...
y = modelClynesKohnBoth(p,args.EXPTIME/1000,args.EXPTIME/1000,args.FPS);

index = find(args.seqX < ceil(2*args.EXPTIME*args.FPS/1000)+1);
